...
const ChatPlaceHolder = () => {
    return (
        <div className='w-3/4 bg-[hls(var(--gray-secondary))] flex flex-col items-center justify-center py-10'>
            <div className='flex flex-col items-center w-full justify-center py-10 gap-4'>
                <Image src={"/desktop-hero.png"} alt='Hero' width={420} height={155} />
                <p className='text-3xl font-extralight mt-5 mb-2'>Download WhatsApp for Windows</p>
                <p className='w-1/2 text-center text-[hls(var(--gray-primary))] text-sm text-muted-foreground'>
                    Make calls, share your screen and get a faster experience when you download the Windows app.
                </p>

                <Button className='rounded-full my-5 bg-green-primary hover:bg-[hls(var(--gray-primary))]'>
